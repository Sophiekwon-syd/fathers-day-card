...
- [ ] **Step 3: Implement the pure card state machine**
...
- [ ] **Step 4: Add the semantic shell and module entry point**
...
- [ ] **Step 5: Add scripts and run the tests**
...
- [ ] **Step 1: Generate one coordinated contact sheet for visual approval**
...
- [ ] **Step 2: Generate the seven production assets from the approved contact sheet**
...
- [ ] **Step 3: Inspect every generated image at full resolution**
...
- [ ] **Step 4: Optimise and document the assets**
...
- [ ] **Step 2: Run the test and confirm it fails before the full markup exists**

Run: `node --test tests/dom-contract.test.js`

Expected: FAIL on at least one missing required string.

- [ ] **Step 3: Implement the closed and open card markup**
...
- [ ] **Step 4: Implement the physical opening motion**
...
- [ ] **Step 1: Select source frames without generative alteration**
...
- [ ] **Step 2: Write a source-policy test**
...
- [ ] **Step 3: Create `assets/portraits/provenance.json`**
...
- [ ] **Step 4: Animate the inside scene**
...
- [ ] **Step 5: Reveal message groups and restore focus**
...
- [ ] **Step 1: Create contact sheets and inspect all 11 photos and 5 videos**
...
- [ ] **Step 3: Confirm the validation test fails before media output exists**

Run: `node --test tests/media-manifest.test.js`

Expected: FAIL because `manifest.json` does not exist.

- [ ] **Step 4: Convert selected photos and video excerpts**
...
- [ ] **Step 5: Write the final playlist manifest**
...
- [ ] **Step 3: Implement playlist timing and controls**
...
- [ ] **Step 4: Implement the pocket and photo-strip reveal**
...
- [ ] **Step 5: Implement the film layer and finale**
...
- [ ] **Step 1: Add keyboard and focus behaviour**
...
- [ ] **Step 2: Add the no-JavaScript fallback**
...
- [ ] **Step 6: Inspect the final experience visually**
...
- [ ] **Step 7: Document preview and deployment**
